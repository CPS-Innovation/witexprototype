...
in your project root. For Claude Projects, add it to the project knowledge. If using GitHub Copilot or
Claude Code within an IDE like Visual Studio Code, use the following recommended prompts.
